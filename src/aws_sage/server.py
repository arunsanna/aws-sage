#!/usr/bin/env python3
"""AWS Sage - Production-grade AWS MCP server with cross-service intelligence."""
...
from aws_sage.config import SafetyMode, get_config, set_config, ServerConfig
...
from aws_sage.core.environment_manager import get_environment_manager
from aws_sage.core.multi_account import get_multi_account_manager
from aws_sage.execution import get_execution_engine
from aws_sage.safety.classifier import OperationClassifier
from aws_sage.safety.validator import get_safety_enforcer
from aws_sage.composition import get_docs_proxy, get_knowledge_proxy, KnowledgeCategory
from aws_sage.differentiators import (
    get_cost_analyzer,
...
mcp = FastMCP(
    name="aws-sage",
    instructions="""AWS Sage - Intelligent AWS operations with cross-service understanding.
...
Unique capabilities:
- 'discover_resources': Find resources across all services by tags
- 'map_dependencies': Understand what a resource depends on
- 'impact_analysis': Know what breaks before you delete
- 'investigate_incident': Automated troubleshooting workflows
- Cost analysis, LocalStack integration, multi-account support
""",
)
